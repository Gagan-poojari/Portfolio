...
const PROJECTS = [
  ...
  },
  {
    id: 'trident',
    num: '05',
    title: 'Trident Academy',
    sub: 'Premium Institute Marketing Site',
    tagline: 'Mangalore\'s premier SAP & language institute — from neomorphic UI to 100% placement, fully showcased.',
    liveHref: 'https://tridentacademy.in/',
    githubHref: 'https://github.com/Gagan-poojari/',
    image: '/projects/trident.png',
    cat: 'Frontend',
    accent: '#1B57B0',
    stack: ['Next.js', 'React', 'Framer Motion', 'Tailwind CSS', 'Web Speech API', 'EmailJS', 'next/image', 'Lucide React'],
    bullets: [
      'Cinematic landing page with neomorphic glass cards, cursor-tracked tilt effects, and scroll-driven section animations.',
      'Multi-tab Course Vault with live-panel switching for SAP ERP, Software Testing & Java, Accounting, and Language tracks.',
      'Language section with Web Speech API audio greetings in 9 languages and boarding-pass card layout.',
      'Animated marquee testimonials with Google-verified alumni badges, neomorphic WhatsApp widget, and Quick Inquiry form.',
    ],
  },
  {
    id: 'holmac',
